      ...
      <div className="grid w-full items-center gap-14 lg:grid-cols-[1.2fr_0.8fr] lg:gap-20">
        <div>
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <a
              href="#projects"
              className="group inline-flex items-center gap-3 rounded-full bg-[#52624F] px-6 py-3 text-sm font-medium text-white transition-all hover:-translate-y-0.5 hover:bg-[#465443] dark:bg-[#A6B39F] dark:text-[#1D211D]"
            >
              View selected work
            ...
            <a
              ...
              className="inline-flex items-center rounded-full border border-[#D2CCBF] px-6 py-3 text-sm font-medium text-[#3D463E] transition-all hover:border-[#B56F4D] hover:text-[#B56F4D] dark:border-[#3A403A] dark:text-[#D9DDD7] dark:hover:border-[#D39570] dark:hover:text-[#D39570]"
            >
              Download resume
            </a>
          </div>
          ...
          <div className="mt-14 flex flex-wrap items-center gap-x-7 gap-y-3 border-t border-[#DDD8CC] pt-5 dark:border-[#3A403A]">
            ...
            {["Laravel", "React", "JavaScript", "MySQL", "Git"].map((item) => (
              <span
                key={item}
        ...
        <div className="relative mx-auto w-full max-w-sm lg:mx-0 lg:ml-auto">
          ...
          <div className="overflow-hidden rounded-[2rem] bg-[#E5DFD3] p-3 dark:bg-[#252A25]">
            <img
